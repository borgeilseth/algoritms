...
class HigherEdSolver:
    ...
    def initialize(self, institutions):
        ...
        for institution in institutions:
            self.institutions.update({institution: ""})

    def parent_institution(self, institution):
        while self.institutions[institution] != "":
            institution = self.institutions[institution]
        return institution

    def fuse(self, institution1, institution2, new_institution):
        self.institutions.update({
            new_institution: "",
            institution1: new_institution,
            institution2: new_institution
        })

        pprint(self.institutions)
